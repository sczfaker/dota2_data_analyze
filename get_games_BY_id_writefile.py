...
max_match_id = 5507166100#7-10
target_match_num = 1000
lowest_mmr = 4560  # 匹配定位线，筛选该分数段以上的天梯比赛 
...
time_limit="2020-07-01 08:54:01"
def crawl(input_url):
...
recurrent_times = 0
write_tag = 0
with open('./data_recent_mmr/matches_list_ranking_0710.csv','w+',encoding='utf-8') as fout:
    ...
    while(len(match_list)<target_match_num):
        ...
        for i in range(len(json_content)):
            ...
            if int(avg_mmr)<lowest_mmr:  # 匹配等级过低，忽略
                continue
            if int(duration)<1300:   # 比赛时间过短，小于15min，视作有人掉线，忽略。
                continue
