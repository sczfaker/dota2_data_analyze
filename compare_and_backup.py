...
class Match_stat(object):
    ...
    def __init__(self,update_dataset_and_testset=False):
        ...
        if update_dataset_and_testset:
            ...
            self.MODEL_NAME="model_2020-07-10_801.pkl"#'model_'+str(datetime.date.today())+"_"+str(self.pre_lenth)+'.pkl'#"model_2020-07-06.pkl#"model_2020-07-06.pkl"
    ...
    def match_team(self):
        return 
    def model_rank(self):
        f="exp_1000.csv"#"matches_0727.csv"
        ...
        for one_game in real_test_set.values:
            ...
            # radiant_team,dire_team,result=i["天辉英雄"],i["夜魇英雄"],i["天辉是否胜利"]
            # print (radiant_team,dire_team,radiant_win)
            ...
            if rate>75:
                ...
                if confirm=="radiant" and radiant_win:
                    right+=1
                elif confirm=="dire" and radiant_win==False:
                    right+=1
            if radiant_win:
                radiant_count+=1
            else:
        ...
        return right,count_75,right/count_75,total-right,radiant_count,dire_count
